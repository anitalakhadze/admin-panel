...
public class CreateUserRequest {
    ...
    @Size(max = 25, message = "IP Address should be less than 20 characters")
    private String ipAddress;

    @NotNull(message = "ReturnURL should not be null")
    @Pattern(regexp = "(https?://)?([\\\\da-z.-]+)\\.([a-z.]{2,6})[/\\\\w .-]*/?",
            message = "Incorrect Format for Returl URL")
    @Size(max = 100, message = "Return URL should be less than 20 characters")

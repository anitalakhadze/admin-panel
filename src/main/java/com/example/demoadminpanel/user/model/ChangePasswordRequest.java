...
public class ChangePasswordRequest {
    ...
    @Size(min = 8, max = 20, message = "oldPassword-Password should be {min}-{max} characters long.")
    ...
    @Size(min = 8, max = 20, message = "newPassword-Password should be {min}-{max} characters long.")
    ...
    @Size(min = 8, max = 20, message = "newPasswordDub-Password should be {min}-{max} characters long.")
